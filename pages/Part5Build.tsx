                                    ...
                                    <div className="flex flex-col md:flex-row gap-4">
                                        ...
                                        <div className="w-full md:w-2/3">
                                            <div className="mb-4">
                                                ...
                                                <p className="text-xs text-slate-500">{providerDisplayName} will write a highly specific prompt for this phase based on the Build Plan.</p>
                                            </div>
                ...
                <section className="space-y-4 pt-8 border-t border-slate-800">
                    ...
                    <GlassCard className="space-y-4">
                        ...
                        <div className="flex justify-end">
                            ...
                            >
                                {isTroubleLoading ? <><Loader2 className="animate-spin" size={16} /> Analyzing...</> : <><AlertTriangle size={16} /> Fix with {providerDisplayName}</>}
                            </Button>
                        </div>
