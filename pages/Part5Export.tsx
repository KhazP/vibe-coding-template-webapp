...
import {
    ...
    ArrowRight, Monitor, BookOpen, Check, Bot
} from 'lucide-react';
...
const ChecklistItem: React.FC<{
    ...
    <div
        onClick={() => toggle(id)}
        className={`flex items-start gap-3 p-3 rounded-lg border transition-all cursor-pointer select-none group ${isChecked
                    ...
                    <GlassCard className="h-full flex flex-col">
                        <div className="flex-1 space-y-4 mb-8">
                            ...
                            <div className="max-h-[500px] overflow-y-auto custom-scrollbar pr-1">
                                {/* Core Docs Group */}
                                <div className="mb-4">
                                    <div className="text-[10px] text-slate-500 uppercase tracking-widest font-bold px-1 mb-2 flex items-center gap-2">
                                        <FolderOpen size={10} /> Core Documentation
                                    </div>
                                ...
                                {hasAgentConfig && (
                                    <div>
                                        <div className="text-[10px] text-slate-500 uppercase tracking-widest font-bold px-1 mb-2 flex items-center gap-2">
                                            <Bot size={10} /> Agent Configuration
                                        </div>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                            <FileRow
                                                name={FILE_NAMES.AGENTS_MD}
                                                desc="Universal Brain"
