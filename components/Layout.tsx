...
const NavItem: React.FC<{
  ...
  const content = (
    <div className={`relative flex items-center justify-between px-6 py-3.5 transition-colors duration-300 z-10 ${isActive ? 'text-primary-400' : 'text-slate-500 group-hover:text-slate-200'
      }`}>
        ...
        >
          ...
          {isActive && (
            <motion.div
              ...
              className="absolute inset-0 bg-gradient-to-r from-primary-500/20 to-primary-500/5 border-l-2 border-primary-500 shadow-[inset_10px_0_20px_-10px_rgba(16,185,129,0.2)]"
